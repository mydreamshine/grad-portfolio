...
CCamera::CCamera(CCamera *pCamera)
{
	...
	else
	{
		...
		m_fYaw = 0.0f;
		m_xmf3Offset = XMFLOAT3(0.0f, 0.0f, 0.0f);
		m_xmf3Position = XMFLOAT3(0.0f, 0.0f, 0.1f);
		m_fTimeLag = 0.0f;
		m_xmf3LookAtWorld = XMFLOAT3(0.0f, 0.0f, 0.0f);
		m_nMode = 0x00;
		m_pPlayer = NULL;
...
{
	// 뷰변환 + 투영변환 업로드
	XMFLOAT4X4 xmf4x4ViewProjection = Matrix4x4::Multiply(m_xmf4x4View, m_xmf4x4Projection);
	XMStoreFloat4x4(&xmf4x4ViewProjection, XMMatrixTranspose(XMLoadFloat4x4(&xmf4x4ViewProjection)));
	pd3dCommandList->SetGraphicsRoot32BitConstants(0, 16, &xmf4x4ViewProjection, 0);
}
